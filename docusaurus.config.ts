...
const config: Config = {
  title: "tlipoca9's Tomb",
  tagline: 'Keep it Simple & Stupid',
  favicon: 'img/Show My Cat.png',

  // Set the production url of your site here
  url: 'https://tlipoca9.github.io',
  ...
  organizationName: 'tlipoca9', // Usually your GitHub org/user name.
  projectName: 'tomb', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/tlipoca9',
          label: 'GitHub',
          position: 'right',
        },
      ],
